# -*- coding: utf-8 -*-
"""
Created on Fri Oct  9 18:41:39 2020
...
class MGA(object):
    def __init__(self, DNA_size, DNA_bound, cross_rate, mutation_rate, pop_size):
        ...
        self.pop = np.random.randint(*DNA_bound, size=(self.pop_size, self.DNA_size) )
...
for _ in range(N_GENERATIONS):                    # 100 generations
    DNA_prod, pred = ga.evolve(10)          # natural selection, crossover and mutation
