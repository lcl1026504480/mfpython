# -*- coding: utf-8 -*-
"""
Created on Sat Oct 10 09:30:26 2020
...
N_GENERATIONS = 200
MUT_STRENGTH = DNA_BOUND[1]-DNA_BOUND[0]      # initial step size (dynamic mutation strength)
...
parent = np.random.uniform(*DNA_BOUND,DNA_SIZE)   # parent DNA
